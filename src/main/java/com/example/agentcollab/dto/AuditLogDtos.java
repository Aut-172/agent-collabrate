...
public final class AuditLogDtos {
    ...
    public record AuditLogResponse(Long id, Long actorUserId, String actorUsername, Long projectId, String action,
                                   String entityType, Long entityId, String requestId,
                                   JsonNode details, Instant createdAt) {
        public static AuditLogResponse from(AuditLog a) {
            return from(a, null);
        }
        public static AuditLogResponse from(AuditLog a, String actorUsername) {
            return new AuditLogResponse(a.getId(), a.getActorUserId(), actorUsername, a.getProjectId(), a.getAction(),
