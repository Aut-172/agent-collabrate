...
export function BuildPlanSection({workflow,document,plan,members=[],warnings=[],editing,draft,busy,canApprovePlan,planNeedsRegeneration,onRegeneratePlan,onEdit,onDraft,onCancel,onSave,onApprove,onGranularity,onCreateTasks}){
  const [selected,setSelected]=useState([]),[reason,setReason]=useState(''),[assignmentEditing,setAssignmentEditing]=useState(false),[assignmentDraft,setAssignmentDraft]=useState(null)
