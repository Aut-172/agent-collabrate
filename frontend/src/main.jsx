...
export function BuildPlanSection({workflow,document,plan,warnings=[],editing,draft,busy,canApprovePlan,planNeedsRegeneration,onRegeneratePlan,onEdit,onDraft,onCancel,onSave,onApprove,onGranularity,onCreateTasks}){
